...
for item in news_list:
    ...
    # 修复图片插入：用 .format() 避免 f-string 语法冲突
    if item['img_url']:
        msg += '<img src="{}" alt="新闻配图" width="100%" style="max-width:100%; height:auto;" />\n\n'.format(item['img_url'])
...
# PushPlus 发送（POST + html 模板，确保图片显示）
